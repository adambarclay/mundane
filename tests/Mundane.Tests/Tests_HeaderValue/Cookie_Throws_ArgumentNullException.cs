...
public static class Cookie_Throws_ArgumentNullException
{
	...
	{
		{
			var exception = Assert.ThrowsAny<ArgumentNullException>(() => HeaderValue.SessionCookie(null!, "value"));
		...
		{
			var exception = Assert.ThrowsAny<ArgumentNullException>(
				() => HeaderValue.PersistentCookie(null!, "value", TimeSpan.MaxValue, "/", string.Empty, true, true));
	...
	public static void When_The_Value_Parameter_Is_Null()
	{
		...
		{
			var exception = Assert.ThrowsAny<ArgumentNullException>(
				() => HeaderValue.PersistentCookie("name", null!, TimeSpan.MaxValue, "/", string.Empty, true, true));
