...
public static class Persistent_Cookie_Returns_The_Correct_Value
{
	...
	public static void When_Domain_Has_Been_Set()
	{
		...
		var maxAge = TimeSpan.FromSeconds(RandomNumberGenerator.GetInt32(0, int.MaxValue));
	...
	public static void When_Path_Has_Been_Set()
	{
		...
		var expected = name + "=" + value + ";path=" + path + ";max-age=" + maxAge.TotalSeconds + ";secure;httponly";
