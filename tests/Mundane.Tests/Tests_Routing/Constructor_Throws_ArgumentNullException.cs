...
public static class Constructor_Throws_ArgumentNullException
{
	...
	{
		var exception = Assert.ThrowsAny<ArgumentNullException>(() => new Routing(_ => { }, (MundaneEndpoint)null!));
	...
	{
		var exception =
			Assert.ThrowsAny<ArgumentNullException>(() => new Routing(_ => { }, (MundaneEndpointNoParameters)null!));
