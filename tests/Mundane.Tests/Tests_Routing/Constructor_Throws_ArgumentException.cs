...
public static class Constructor_Throws_ArgumentException
{
	...
	{
		var exception = Assert.ThrowsAny<ArgumentException>(() => new Routing(o => o.Get("/inva}lid", Response.Ok)));
	...
	{
		var exception = Assert.ThrowsAny<ArgumentException>(() => new Routing(o => o.Get("/{captureOne", Response.Ok)));
